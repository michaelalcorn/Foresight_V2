          ...
          <div class="md:grid md:grid-cols-12 md:gap-6 items-center">
            ...
            >
              <div class="relative">
                <!--
                  ...
                  -->
                <img
                  class="md:max-w-none hover:transform scale-200"
            ...
            >
              <div class="md:pr-4 lg:pr-12 xl:pr-16">
                ...
                <h3 class="h3 mb-3">Purpose-built to make you user-obsessed</h3>
                <p class="text-xl text-gray-800 mb-4">
                  Make every user matter by extracting the Value Intelligence™
                  behind their software experience
                </p>
                <ul class="flex flex-wrap text-lg text-gray-800 -mx-2 -my-1">
                ...
                <div class="flex items-start mt-8">
                  ...
                  />
                  <div>
                    <blockquote class="text-gray-800 italic mb-3">
