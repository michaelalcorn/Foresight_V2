    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 relative">
      ...
      >
        ...
        >
          <defs>
            ...
            >
              <stop stop-color="#0D0D5B" stop-opacity=".01" />
              <stop offset="1" stop-color="#0D0D5B" stop-opacity=".32" />
            </linearGradient>
          </defs>
          <path
            fill-rule="evenodd"
      ...
      <div class="relative pt-32 pb-10 md:pt-40 md:pb-16">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-16">
          <h1 class="h1 mb-4" data-aos="fade-up">Gain Foresight</h1>
          <p
            class="text-xl text-gray-800 mb-8"
            data-aos="fade-up"
            data-aos-delay="200"
          >
            Foresight accelerates scale for B2B SaaS by enabling companies to
            personalize their offerings to specific users, buyers, and end
            markets.
          </p>
